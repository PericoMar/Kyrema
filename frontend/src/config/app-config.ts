export const AppConfig = {
    ...
    STRIPE_PUBLIC_KEY: 'pk_test_51Q12bbRumADZjQkjkNacdoPDMrHwpC1GYPp8tkIdNhHTH2XGkY04JdFe07jBTSq9VeZhz4oKr1UFqVxxCDh2pNzY00ZpS5BsIO',
    APP_NAME: 'My Angular App',
    SOCIEDAD_ADMIN_ID: '1',
    PREFIJO_LETRAS_IDENTIFICACION_ANEXOS: 'ANEXOS_',
    PREFIJO_LETRAS_IDENTIFICACION: 'PRODUCTO_'
  };
