  ...
  public columnDefs: ColDef[] = [
    ...
    { field: 'tipoSociedad', headerName: 'Tipo Sociedad', width: 200 },
    {
      ...
      cellRenderer: (params : any) => {
        return `
        <a [routerLink]="['/sociedades/pagos', sociedad.nombre]" routerLinkActive="active">Pagos y precios</a>
        <a [routerLink]="['/sociedades/productos', params.data.sociedad]">Productos</a>
        <a [routerLink]="['/sociedades/permisos', params.data.sociedad]">Permisos</a>
        <a [routerLink]="['/sociedades/modificar', params.data.sociedad]">Modificar</a>
        <button (click)="onBorrarClick(params.data)">Borrar</button>
      `;
      },
      suppressMenu: true,
      sortable: false,
